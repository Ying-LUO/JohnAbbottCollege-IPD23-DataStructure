...
class LinkedListArrayOfStrings_JunitTest {
    ...
    public void insertAtIndex_AssertSucceed(){
        ...
        assertArrayEquals(linkedListArray.toArray(), new String[]{ "1str", "2str", "3str"});
        linkedListArray.insertValueAtIndex(2, "4str"); // insert in the middle
        assertEquals(linkedListArray.getSize(), 4);
        assertArrayEquals(linkedListArray.toArray(), new String[]{ "1str", "2str", "4str", "3str"});
        linkedListArray.insertValueAtIndex(0, "0str"); // insert at the beginning
        assertEquals(linkedListArray.getSize(), 5);
        assertArrayEquals(linkedListArray.toArray(), new String[]{ "0str", "1str", "2str", "4str", "3str"});
    }
